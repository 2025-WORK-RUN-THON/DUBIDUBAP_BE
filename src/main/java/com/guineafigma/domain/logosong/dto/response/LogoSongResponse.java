...
public class LogoSongResponse {
    ...
    @Schema(description = "로고송 고유 식별자", example = "123")
    private Long id;
    ...
    @Schema(description = "브랜드/서비스명", example = "카페 뒤비뒤밥")
    ...
    @Schema(description = "사용자들의 좋아요 개수", example = "42")
    private Integer likeCount;

    @Schema(description = "로고송 재생 및 조회 횟수", example = "1250")
    private Integer viewCount;

    @Schema(description = "로고송 생성 일시", example = "2024-01-15T14:30:00")
    private LocalDateTime createdAt;

    @Schema(description = "마지막 수정 일시", example = "2024-01-15T15:45:00")
